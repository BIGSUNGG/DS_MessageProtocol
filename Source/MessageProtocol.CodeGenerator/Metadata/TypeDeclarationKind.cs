...
namespace MessageProtocol.CodeGenerator.Metadata
{
    ...
    {
        public static TypeDeclarationKind GetDeclarationKind(INamedTypeSymbol symbol)
        {
        ...
        public static string GetDeclarationKeyword(TypeDeclarationKind declarationKind)
        {
            switch (declarationKind)
            {
                ...
                case TypeDeclarationKind.RecordClass: return "record";
                case TypeDeclarationKind.RecordStruct: return "record struct";
                case TypeDeclarationKind.Interface: return "interface";
